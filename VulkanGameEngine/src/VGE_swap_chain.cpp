...
VgeSwapChain::VgeSwapChain(VgeDevice &deviceRef, VkExtent2D windowExtent, std::shared_ptr<VgeSwapChain> previous)
    : device{deviceRef}, windowExtent{windowExtent}, oldSwapChain{previous} {
  init();

  // cleanup old swap chain since its no longer needed

...
namespace VGE
{
    ...
    void VgeCamera::setViewDirection(glm::vec3 position, glm::vec3 direction, glm::vec3 up)
    {
    ...
    void VgeCamera::setViewTarget(glm::vec3 position, glm::vec3 target, glm::vec3 up)
    {

...
layout(std140, binding = 1) buffer InstanceBuffer {
    mat4 modelMatrix;
    mat3 normalMatrix;
} instance;
...
void main()
{
    ...
    //gl_Position = vec4(instance.transform * inPosition + instance.offset, 0.0, 1.0);
    gl_Position = ubo.projectionViewMatrix * instance.modelMatrix * vec4(inPosition, 1.0);
    ...
    //vec3 normalWorldSpace = normalize(mat3(instance.modelMatrix) * inNormal);

    vec3 normalWorldSpace = normalize(mat3(instance.normalMatrix) * inNormal);
